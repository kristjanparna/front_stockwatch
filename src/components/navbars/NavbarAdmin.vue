            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <router-link to="/">
                      <a v-on:click="clearSessionStorage" class="nav-link active" aria-current="page" href="#">Log
                        out</a>
                    </router-link>
                  </li>
                </ul>
                <form class="d-flex">
                  <input v-model="usernameQuery" class="form-control me-2" type="search" placeholder="Otsi kasutajat"
                         aria-label="Search">
